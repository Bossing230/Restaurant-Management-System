...
app.use(`${API}/orders`,       authenticate, require('./src/routes/order'));
app.use(`${API}/tables`,       authenticate, require('./src/routes/tables'));
app.use(`${API}/inventory`,    authenticate, require('./src/routes/inventory'));
app.use(`${API}/customers`,    authenticate, require('./src/routes/customer'));
app.use(`${API}/reservations`, authenticate, require('./src/routes/reservation'));
app.use(`${API}/reports`,      authenticate, require('./src/routes/reports'));
app.use(`${API}/staff`,        authenticate, require('./src/routes/staff'));
app.use(`${API}/settings`,     authenticate, require('./src/routes/setting'));
